...
<?php if (count($header_row) ==0):  ?> 
    <div class="view-header">
      <div class="cars-summary">Comparing <strong>0</strong>. Max amount of properties that can be compared: <strong>3</strong>.</div>    
	</div> 
    <h2 class="empty">Select up to 3 Properties to compare here from the Properties Lists.</h2>
  <?php else : ?>
