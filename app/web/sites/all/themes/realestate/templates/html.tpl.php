...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <!-- iOS Icons -->
      <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php print $base_path; ?><?php print $directory; ?>/apple-touch-icon-144-precomposed.png">
      <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php print $base_path; ?><?php print $directory; ?>/apple-touch-icon-114-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php print $base_path; ?><?php print $directory; ?>/apple-touch-icon-72-precomposed.png">
                      <link rel="apple-touch-icon-precomposed" href="<?php print $base_path; ?><?php print $directory; ?>/apple-touch-icon-57-precomposed.png">
